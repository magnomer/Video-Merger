...
const PLanguageMap = {
  en: {
    ...
    error: "Error",
    noGroups: "No matching groups found.",
    groupsTitle: "Groups",
    ...
    settingCustom: "Advanced: custom pattern (regular expression)",
  ...
  ko: {
    ...
    settingStyle: "번호 형식",
    settingCustom: "고급: 사용자 지정 패턴 (정규식)",
...
function PLanguageApplySet() {
  ...
  PLanguageTextSet(".PSSettingHeading", text.settingHeading);
  PLanguageTextSet(".PSSettingLead", text.settingLead);
